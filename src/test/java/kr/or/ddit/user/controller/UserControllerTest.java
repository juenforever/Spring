...
public class UserControllerTest extends ControllerTestEnv {
	...
	/**
	 * Method : test 작성자 : PC01 변경이력 : Method 설명 : 사용자 전체 리스트 테스트
	 * 
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Method : test 작성자 : PC01 변경이력 : Method 설명 : 사용자 페이징 리스트 테스트
	 * 
	 * @throws Exception
	 */
	@Test
	public void userPagingListTest() throws Exception {
		...
		/*** When ***/
		MvcResult mvcResult = mockMvc.perform(get("/userPagingList").param("page", "2").param("pageSize", "10"))
				.andReturn();
		ModelAndView mav = mvcResult.getModelAndView();
